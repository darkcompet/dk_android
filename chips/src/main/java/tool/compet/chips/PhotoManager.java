...
/**
 * Used by the {@link tool.compet.chips.BaseRecipientAdapter} to handle fetching
...
public interface PhotoManager {
	...
	/**
	 * Sets the {@link tool.compet.chips.RecipientEntry}'s photo bytes. If the photo bytes
