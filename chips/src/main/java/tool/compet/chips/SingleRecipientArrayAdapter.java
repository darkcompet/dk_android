...
class SingleRecipientArrayAdapter extends ArrayAdapter<RecipientEntry> {
	...
	public SingleRecipientArrayAdapter(Context context, RecipientEntry entry, DropdownChipLayouter dropdownChipLayouter, StateListDrawable deleteDrawable) {
		super(context, dropdownChipLayouter.getAlternateItemLayoutResId(AdapterType.SINGLE_RECIPIENT), new RecipientEntry[]{entry});
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		return mDropdownChipLayouter.bindView(convertView, parent, getItem(position), position, AdapterType.SINGLE_RECIPIENT, null, mDeleteDrawable);
	}
}
