...
package tool.compet.residelayout;
...
public class DkResideLayout extends ViewGroup {
	...
	public DkResideLayout(Context context) {
		this(context, null);
	}

	public DkResideLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public DkResideLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	protected boolean drawChild(@NonNull Canvas canvas, @NonNull View child, long drawingTime) {
		final LayoutParams lp = (LayoutParams) child.getLayoutParams();
		boolean result;
		final int save = canvas.save(); // flag: Canvas.ALL_SAVE_FLAG
	...
	interface SlidingPanelLayoutImpl {
		void invalidateChildRegion(DkResideLayout parent, View child);
	}

	static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
		public void invalidateChildRegion(DkResideLayout parent, View child) {
	...
	private class DisableLayerRunnable implements Runnable {
		...
		@Override
		public void run() {
			if (mChildView.getParent() == DkResideLayout.this) {
