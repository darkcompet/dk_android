 ...
 */
public class DkCompatConstraintLayout extends ConstraintLayout {
	...
	public DkCompatConstraintLayout(Context context) {
		super(context);
		init(context);
	}

	public DkCompatConstraintLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkCompatConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
