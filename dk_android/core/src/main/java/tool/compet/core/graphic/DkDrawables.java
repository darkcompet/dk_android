...
public class DkDrawables {
	...
	private static Drawable createCircleStateListDrawable(Resources resources, int radius,
		...
		drawable.addState(new int[]{android.R.attr.state_pressed}, createCircleBitmapDrawable(resources, radius, pressedColor));
		drawable.addState(new int[]{-android.R.attr.state_enabled}, createCircleBitmapDrawable(resources, radius, unableColor));
		drawable.addState(StateSet.WILD_CARD, createCircleBitmapDrawable(resources, radius, normalColor));
	...
	private static Drawable createRectStateListDrawable(Resources resources, int width, int height,
		...
		drawable.addState(new int[]{android.R.attr.state_pressed}, createRectBitmapDrawable(resources, width, height, pressedColor, cornerRadius));
		drawable.addState(new int[]{-android.R.attr.state_enabled}, createRectBitmapDrawable(resources, width, height, unableColor, cornerRadius));
		drawable.addState(StateSet.WILD_CARD, createRectBitmapDrawable(resources, width, height, normalColor, cornerRadius));
