...
public class DkCompatRadioButton extends AppCompatRadioButton {
	...
	public DkCompatRadioButton(Context context) {
		super(context);
		init(context);
	}

	public DkCompatRadioButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkCompatRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
