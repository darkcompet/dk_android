 ...
 */
public class DkCompatButton extends AppCompatButton {
	...
	public DkCompatButton(Context context) {
		super(context);
		init(context);
	}

	public DkCompatButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkCompatButton(Context context, AttributeSet attrs, int defStyleAttr) {
