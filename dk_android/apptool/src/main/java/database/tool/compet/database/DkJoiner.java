...
class DkJoiner extends MyExpression {
    ...
    DkJoiner(DkGrammar grammar) {
        super(grammar, K_BASIC, K_AND);
    }
    ...
    public DkJoiner where(String name, Object value) {
        expressions().add(new MyExpression(grammar, K_BASIC, K_AND, name, K_EQ, value));
        return this;
    }

    public DkJoiner orWhere(String name, Object value) {
        expressions().add(new MyExpression(grammar, K_BASIC, K_OR, name, K_EQ, value));
        return this;
    }

    public DkJoiner where(String name, String operator, Object value) {
        expressions().add(new MyExpression(grammar, K_BASIC, K_AND, name, operator, value));
        return this;
    }

    public DkJoiner orWhere(String name, String operator, Object value) {
        expressions().add(new MyExpression(grammar, K_BASIC, K_OR, name, operator, value));
        return this;
    }

    public DkJoiner whereNull(String name) {
        expressions().add(new MyExpression(grammar, K_NULL, K_AND, name, K_IS_NULL));
        return this;
    }

    public DkJoiner orWhereNull(String name) {
        expressions().add(new MyExpression(grammar, K_NULL, K_OR, name, K_IS_NULL));
        return this;
    }

    public DkJoiner whereNotNull(String name) {
        expressions().add(new MyExpression(grammar, K_NOT_NULL, K_AND, name, K_IS_NOT_NULL));
        return this;
    }

    public DkJoiner orWhereNotNull(String name) {
        expressions().add(new MyExpression(grammar, K_NOT_NULL, K_OR, name, K_IS_NOT_NULL));
        return this;
    }

    public DkJoiner whereIn(String name, Iterable values) {
        expressions().add(new MyExpression(grammar, K_IN, K_AND, name, K_IN, values));
        return this;
    }

    public DkJoiner orWhereIn(String name, Iterable values) {
        expressions().add(new MyExpression(grammar, K_IN, K_OR, name, K_IN, values));
        return this;
    }

    public DkJoiner whereNotIn(String name, Iterable values) {
        expressions().add(new MyExpression(grammar, K_NOT_IN, K_AND, name, K_NOT_IN, values));
        return this;
    }

    public DkJoiner orWhereNotIn(String name, Iterable values) {
        expressions().add(new MyExpression(grammar, K_NOT_IN, K_OR, name, K_NOT_IN, values));
        return this;
    }

    public DkJoiner whereRaw(String sql) {
        expressions().add(new MyExpression(grammar, K_RAW, K_AND, sql));
        return this;
    }

    public DkJoiner orWhereRaw(String sql) {
        expressions().add(new MyExpression(grammar, K_RAW, K_OR, sql));
        return this;
    }
