...
import static tool.compet.core.timing.DkFrameCallbackProvider.FRAME_DELAY;
import static tool.compet.core.timing.DkFrameCallbackProvider.FRAME_START;
 ...
 * <p></p>
 * デフォルトのフレームコールバックはHandlerのサブクラスのため、start()が呼び出される前にLooperのloop()が
 * 既に実行されている必要があります。
 */
